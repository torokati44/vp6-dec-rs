/* Automatically generated by configure, and then
   modified by hand to make it more portable. */
...
#define HAVE_EXP2F 1
#define HAVE_EXPF 1
//#define HAVE_ISINF 1 // set by command line
//#define HAVE_ISNAN 1 // set by command line
